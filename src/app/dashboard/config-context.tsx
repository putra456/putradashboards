...
interface LoginConfig {
  ...
  getAccessButton: string;
}

interface HomeConfig {
  welcomeTitle: string;
  showTiktokStep: boolean;
  tiktokTitle: string;
  tiktokDesc: string;
  tiktokButton: string;
  tiktokConfirmButton: string;
  scriptTitle: string;
  scriptDesc: string;
  scriptButton: string;
  accessTitle: string;
...
const DEFAULT_CONFIG: AppConfig = {
  site: {
    name: "Xau×Putra",
    tagline: "Premium Trading EA Platform",
    favicon:
      "https://i.postimg.cc/pVCw2NjM/1778327126809-019e0c8d-4a61-7565-b5ba-b5dd6c6e3fe7.png",
    logo: "https://i.postimg.cc/pVCw2NjM/1778327126809-019e0c8d-4a61-7565-b5ba-b5dd6c6e3fe7.png",
    copyright: "© 2024 Xau×Putra • Premium Quant Systems",
  },
  colors: {
    primary: "#ffffff",
    accent: "#34c759",
  ...
  links: {
    tiktok: "https://www.tiktok.com/@jeiiwaaaa?_r=1&_t=ZS-96DRrdP82K4",
    whatsapp: "6282230304458",
    whatsappMessage: "Halo Owner Xau×Putra, saya mau get access EA Premium.",
  },
  ea: {
    name: "ScalpGridHedge Premium",
    version: "v3.0",
    filename: "ScalpGridHedge_Premium.mq4",
    description:
      "Institutional-Grade Scalping + Dynamic Grid + Bi-Directional Hedging EA for MT4. Optimized for Cent Accounts on M1/M5 timeframes.",
  },
  about: {
    title: "About Dev",
    devName: "Xau×Putra",
    devSubtitle: "Premium Quant Systems",
    description:
      "Xau×Putra adalah platform EA (Expert Advisor) trading premium yang dikembangkan oleh tim quant trader berpengalaman. Fokus kami pada scalping, grid recovery, dan hedging strategy untuk menghasilkan profit konsisten di market forex & gold.",
    tags: ["MT4", "MQL4", "Scalping", "Grid", "Hedge"],
    features: [
      {
        icon: "Zap",
  ...
  login: {
    title: "Xau×Putra",
    subtitle: "Premium Trading EA Platform",
    showGetAccess: true,
    getAccessText:
      "Belum punya akun? Hubungi owner untuk mendapatkan akun dan full access EA Premium dengan setup & support.",
    getAccessButton: "Get Access via WhatsApp",
  },
  home: {
    welcomeTitle: "Welcome",
    showTiktokStep: true,
    tiktokTitle: "Step 1 — Follow TikTok",
    tiktokDesc:
      "Follow TikTok owner @jeiiwaaaa untuk mendapatkan akses EA Premium. Setelah follow, klik Confirm Follow.",
    tiktokButton: "Open TikTok",
    tiktokConfirmButton: "Confirm Follow",
    scriptTitle: "Step 2 — Get EA Script",
    scriptDesc:
      "Setelah follow TikTok, klik tombol dibawah untuk melihat dan download script EA Premium.",
    scriptButton: "Get EA Script",
    accessTitle: "Get Access",
    accessDesc: "Hubungi owner untuk full access, setup, dan support EA Premium.",
    accessButton: "Chat Owner via WhatsApp",
  },
  admin: {
    title: "Admin Panel",
